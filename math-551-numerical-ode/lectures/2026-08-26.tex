...
\begin{align*}
  \Phi^{t_0,t_0}(x_0)&=x_0,
  &\Phi^{t_0,t_0}&=I,\\
  \Phi^{t_2,t_1}\bigl(\Phi^{t_1,t_0}(x_0)\bigr)
    &=\Phi^{t_2,t_0}(x_0).
\end{align*}
...
\begin{align*}
  \frac{d}{dt}\Phi^{t,t_0}(x_0)
    &=f(t,x(t)),\\
  \frac{d^2}{dt^2}\Phi^{t,t_0}(x_0)
...
Wronskian matrix
\[
  W(t)=\frac{\partial}{\partial x_0}\Phi^{t,t_0}(x_0)
